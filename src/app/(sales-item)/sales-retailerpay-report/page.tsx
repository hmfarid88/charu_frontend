...
const Page = () => {
    ...
    useEffect(() => {
        fetch(`${apiBaseUrl}/paymentApi/getEmployeeRetailerPayment?username=${encodeURIComponent(username)}`)
    ...
    return (
        <div className="container-2xl">
            <div className="flex flex-col w-full min-h-[calc(100vh-228px)] items-center justify-center p-4">
                <div className="flex p-5 justify-end items-end"><DateToDate routePath="/datewise-retailer-payment" /></div>
