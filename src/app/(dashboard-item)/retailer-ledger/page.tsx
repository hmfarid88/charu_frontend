...
const Page = () => {
  ...
  useEffect(() => {
    fetch(`${apiBaseUrl}/retailer/retailerBalance?username=${username}`)
              ...
              <tbody>
                {filteredProducts?.map((product, index) => (
                  <tr key={index}>
                    ...
                    <td><a href="#my_modal_retail_ledger"><button onClick={() => setSupplierName(product?.retailer)} className="btn btn-xs btn-info">Details</button></a></td>
